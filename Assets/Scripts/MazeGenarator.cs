...
public static class MazeGenerator
{
    ...
    private static WallState[,] ApplyRecursiveBacktraker(WallState[,] maze, int width, int height) 
    {
        ...
        while (positionStack.Count > 0) 
        {
            ...
            if (neighbours.Count > 0) 
            {
                ...
                var randomNeigbour = neighbours[randIndex];
    ...
    public static WallState[,] Generate(int width, int height) 
    {
        ...
        return ApplyRecursiveBacktraker(maze,width,height);
    }
}
